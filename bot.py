...
from rutas import buscar_itinerario, formatear_itinerario
...
async def recibir_destino(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if rutas_comunes:
        ...
        # posible con transbordo(s) usando el motor de rutas.py.
        tramos = buscar_itinerario(origen, destino)
        texto_buses = formatear_itinerario(tramos)
